...
*/
CONST UBYTE LanguageNativeName[]	=	{0xE6,0x97,0xA5,0xE6,0x9C,0xAC,0xE8,0xAA,0x9E,0};	/*3*/

CONST UBYTE Monday[]				=	{0xE6,0x9C,0x88,0xE6,0x9B,0x9C,0xE6,0x97,0xA5,0};	/*3*/
CONST UBYTE Tuesday[]				=	{0xE7,0x81,0xAB,0xE6,0x9B,0x9C,0xE6,0x97,0xA5,0};	/*3*/
CONST UBYTE Wednesday[]				=	{0xE6,0xB0,0xB4,0xE6,0x9B,0x9C,0xE6,0x97,0xA5,0};	/*3*/
CONST UBYTE Thursday[]				=	{0xE6,0x9C,0xA8,0xE6,0x9B,0x9C,0xE6,0x97,0xA5,0};	/*3*/
CONST UBYTE Friday[]				=	{0xE9,0x87,0x91,0xE6,0x9B,0x9C,0xE6,0x97,0xA5,0};	/*3*/
CONST UBYTE Saturday[]				=	{0xE5,0x9C,0x9F,0xE6,0x9B,0x9C,0xE6,0x97,0xA5,0};	/*3*/
CONST UBYTE Sunday[]				=	{0xE6,0x97,0xA5,0xE6,0x9B,0x9C,0xE6,0x97,0xA5,0};	/*3*/
...
CONST UBYTE Morning[]				=	{0xE5,0x8D,0x88,0xE5,0x89,0x8D,0};					/*2*/
...
CONST UBYTE Yesterday[]				=	{0xE6,0x98,0xA8,0xE6,0x97,0xA5,0};					/*2*/
CONST UBYTE Today[]					=	{0xE4,0xBB,0x8A,0xE6,0x97,0xA5,0};					/*2*/
CONST UBYTE Tomorrow[]				=	{0xE6,0x98,0x8E,0xE6,0x97,0xA5,0};					/*2*/
CONST UBYTE Future[]				=	{0xE6,0x9C,0xAA,0xE6,0x9D,0xA5,0};					/*2*/
