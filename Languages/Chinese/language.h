...
*/
#define LIBRARY_NAME		"chinese.language"
#define LIBRARY_IDENTITY	"chinese.language r0"
...
extern ULONG ExecPerceptionHook(struct Hook *h,struct LanguageContext LanguageContext,ULONG *Message);
/**/
